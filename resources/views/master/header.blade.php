        ...
        <div class="row">
            ...
            <div class="col-md-6 text-center">
                <div class="mainmenu">
                    <nav>
                        <ul>
                        <li class="expand"><a href="{{route('home')}}" title="">Trang Chủ</a></li>
                            <li class="expand"><a href="/">Sản Phẩm </a>
                                <ul class="restrain sub-menu">
                                  @isset($category)
                                      @foreach ($category as $item)
                                <li><a href="{{route('get.list.product',[$item->c_slug,$item->id])}}">{{$item->c_name}}</a></li>
                                      @endforeach
                                  @endisset
                                </ul>	
                            </li>
                ...
                <div class="top-detail text-right">
                    ...
                    <div class="disflow">
                        <div class="expand dropps-menu" >
                            ...
                            @if (Auth::check())
                            <ul class=" restrain language font-italic font-weight-bold">
