  ...
  <body>
    <nav class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0">
      ...
      <ul class="navbar-nav px-3">
        ...
        <a class="nav-link" href="{{route('admin_logout')}}">Sign out</a>
        </li>
      </ul>
    </nav>
        ...
        <nav class="col-md-2 d-none d-md-block bg-light sidebar">
          <div class="sidebar-sticky">
            <ul class="nav flex-column">
              ...
              <li class="nav-item ">
              <a class="nav-link {{\Request::route()->getName()=='admin.get.list.products' ? 'active':' '}}" href="{{route('admin.get.list.products')}}">
              ...
              <li class="nav-item">
                ...
                <li class="nav-item">
                  <a class="nav-link {{\Request::route()->getName()=='list.contact' ? 'active':' '}}" href="{{route('list.contact')}}">
                      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-layers"><polygon points="12 2 2 7 12 12 22 7 12 2"></polygon><polyline points="2 17 12 22 22 17"></polyline><polyline points="2 12 12 17 22 12"></polyline></svg>
                      contact
                    </a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link {{\Request::route()->getName()=='get.list.page_static' ? 'active':' '}}" href="{{route('get.list.page_static ')}}">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-layers"><polygon points="12 2 2 7 12 12 22 7 12 2"></polygon><polyline points="2 17 12 22 22 17"></polyline><polyline points="2 12 12 17 22 12"></polyline></svg>
                        Page_tinh
                      </a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link {{\Request::route()->getName()=='admin.get.warehouse.list' ? 'active':' '}}" href="{{route('admin.get.warehouse.list')}}">
                          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-layers"><polygon points="12 2 2 7 12 12 22 7 12 2"></polygon><polyline points="2 17 12 22 22 17"></polyline><polyline points="2 12 12 17 22 12"></polyline></svg>
                          Quản lý kho
                        </a>
                      </li>
                    {{-- admin.get.warehouse.list --}}
            </ul>
          </div>
        </nav>
